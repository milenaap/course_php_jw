             ...
             <div class="flex">
                 ...
                 <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
                     ...
                     <a 
                        href="/" 
                        aria-current="page" 
                        class="<?= urlIs('/') ? 'bg-gray-900 text-white border-b-2 border-indigo-600' : 'text-gray-500' ?> inline-flex items-center  px-1 pt-1 text-sm font-medium dark:border-indigo-500 dark:text-white"
                        >Home
                    </a>

                     <a 
                        href="/about" 
                        class="<?= urlIs('/about')  ? 'bg-gray-900 text-white border-b-2 border-indigo-600' : 'text-gray-500' ?> inline-flex items-center  px-1 pt-1 text-sm font-medium dark:border-indigo-500 dark:text-white"
                        >About
                    </a>
